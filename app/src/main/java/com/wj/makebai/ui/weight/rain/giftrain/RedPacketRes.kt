...
object RedPacketRes {
    ...
    /*普通红包（无序）*/
    val NORMAL_LIST = intArrayOf(
        R.mipmap.img_red_packet_1,
        R.mipmap.img_red_packet_2,
        R.mipmap.img_red_packet_3
    )
    /*无表情红包*/
    const val NO_EMOTION = R.mipmap.img_red_packet
    /*彩带（无序）*/
    val RIBBON_LIST = intArrayOf(
    ...
    /*爆炸列表*/
    @JvmField
    val BOOM_LIST = intArrayOf( //            R.mipmap.ic_red_packet,
