...
public class ControlManager {
    ...
    //控制事件
    public static final String TV_CONTROL_TAG = "tv_control_tag";
    //播放进度事件
    public static final String TV_PROGRESS_TAG = "tv_progress_tag";
    //播放状态事件
    public static final String TV_STATE_TAG = "tv_state_tag";
    //播放状态事件
    public static final String TV_VOLUME_TAG = "tv_volume_tag";
    ...
    public void initScreenCastCallback() {
        ...
        avtCallback = new AVTransportCallback(avtService) {
            ...
            protected void received(AVTransportInfo info) {
                ...
                WjEventBus.getInit().post(TV_CONTROL_TAG,event);
            }
        };
        ...
        controlPoint.execute(new GetPositionInfo(instanceId, avtService) {
            ...
            public void received(ActionInvocation invocation, PositionInfo positionInfo) {
                if (positionInfo != null) {
                    ...
                    ControlEvent event = new ControlEvent();
                    event.setAvtInfo(info);
                    WjEventBus.getInit().post(TV_PROGRESS_TAG,event);
    ...
    public void getTransportInfo() {
        ...
        controlPoint.execute(new GetTransportInfo(instanceId, avtService) {
            ...
            public void received(ActionInvocation invocation, TransportInfo transportInfo) {
                ...
                ControlEvent event = new ControlEvent();
                event.setAvtInfo(info);
                WjEventBus.getInit().post(TV_STATE_TAG,event);
    ...
    public void getVolume() {
        ...
        controlPoint.execute(new GetVolume(instanceId, rcService) {
            ...
            public void received(ActionInvocation actionInvocation, int currentVolume) {
                ...
                ControlEvent event = new ControlEvent();
                event.setRcInfo(info);
                WjEventBus.getInit().post(TV_VOLUME_TAG,event);
